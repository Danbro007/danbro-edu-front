        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            <h2 class="hLh30 txtOf mt15">
              <span class="c-fff fsize24">{{ courseWebVo.courseTitle }}</span>
            </h2>
            <section class="c-attr-jg">
              <span class="c-fff">价格：</span>
              <b class="c-yellow" style="font-size: 24px"
                >￥{{ courseWebVo.coursePrice }}</b
              >
            </section>
                ...
                <div>
                  ...
                  <div class="course-txt-body-wrap">
                    <section class="course-txt-body">
                      <p v-html="courseWebVo.courseDescription">
                        {{ courseWebVo.courseDescription }}
                      </p>
                    </section>
                  </div>
                </div>
                    ...
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          ...
                          <li
                            class="lh-menu-stair"
                            v-for="chapter in courseWebVo.chapterList"
                ...
                <ul style="height: auto">
                  <li>
                    ...
                    <section class="hLh20 txtOf">
                      <span class="c-999">{{ courseWebVo.teacherIntro }}</span>
                    </section>
                  </li>
                </ul>
              </section>
